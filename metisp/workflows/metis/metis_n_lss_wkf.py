...
n_lss_lingain_task = (task('metis_n_lss_lingain')
            ...
            .with_associated_input(n_lss_dark_task, min_ret=0) # min_ret=0 --> optional input            # .with_main_input(raw_dark)       # check what the minimum number of raw darks is!
...
tn_lss_trace_task = (task("metis_n_lss_trace")
...
n_lss_std_task = (task('metis_n_lss_std')
            ...
            .with_associated_input(n_lss_dark_task)
            .with_associated_input(n_lss_rsrf_task)
            .with_associated_input(tn_lss_trace_task)
