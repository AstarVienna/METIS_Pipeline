...
slitloss_n_lss_task = (task('metis_n_adc_slitloss')
...
flatfield_n_lss_task = (task('metis_n_lss_rsrf')
            .with_recipe("metis_n_lss_rsrf")
            .with_main_input(n_raw_rsrf)
            .with_associated_input(n_wcu_off_raw)
            .with_associated_input(dark_geo_n_lss_task)
            .with_associated_input(linearity_n_lss_task)
            .with_meta_targets([QC1_CALIB])
            .build())

trace_finding_n_lsstask = (task("metis_n_lss_trace")
            .with_recipe("metis_n_lss_trace")
            .with_main_input(n_raw_rsrf_pinh)
            .with_associated_input(n_wcu_off_raw)
            .with_associated_input(dark_geo_n_lss_task)
            .with_associated_input(linearity_n_lss_task)
            .with_associated_input(flatfield_n_lss_task)
            .with_associated_input(calib_persistence, min_ret=0)
            .with_meta_targets([QC1_CALIB])
            .build())

std_reduction_n_lss_task = (task('metis_n_lss_std')
            ...
            .with_associated_input(dark_geo_n_lss_task)
            .with_associated_input(flatfield_n_lss_task)
            .with_associated_input(trace_finding_n_lsstask)
            # .with_associated_input(wavelength_calibration_task)
            .with_associated_input(slitloss_n_lss_task)
...
sci_reduction_n_lss_task = (task('metis_n_lss_sci')
            ...
            .with_associated_input(static_n_lss_dist_sol)
            .with_associated_input(static_n_lss_wave_guess)
            .with_associated_input(std_reduction_n_lss_task)
            .with_associated_input(static_atm_line_cat)
            .with_associated_input(static_n_adc_slitloss)
            .with_associated_input(static_ao_psf_model)
...
mf_model_n_lss_task = (task("metis_n_lss_mf_model")
            .with_main_input(sci_reduction_n_lss_task)
            .with_associated_input(std_reduction_n_lss_task)
            # .with_associated_input(static_ao_psf_model)
            .with_associated_input(static_atm_line_cat)
...
mf_calctrans_n_lss_task = (task("metis_n_lss_mf_calctrans")
            .with_main_input(mf_model_n_lss_task)
            .with_associated_input(static_atm_line_cat)
            .with_associated_input(calib_lsf_kernel)
            .with_associated_input(calib_atm_profile)
...
mf_correct_n_lss_task = (task("metis_n_lss_mf_correct")
            .with_main_input(sci_reduction_n_lss_task)
            .with_associated_input(mf_calctrans_n_lss_task)
