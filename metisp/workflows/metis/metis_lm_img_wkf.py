...
lm_img_flat_task = (task("metis_lm_img_flat")
             ...
             .with_associated_input(dark_task, [MASTER_DARK_2RG])
             .with_associated_input(lingain_task, [GAIN_MAP_2RG, BADPIX_MAP_2RG, LINEARITY_2RG])
