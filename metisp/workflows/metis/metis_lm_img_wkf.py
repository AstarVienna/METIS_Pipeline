...
flat_lm_img_task = (task("metis_lm_img_flat")
...
distortion_lm_img_task = (task('metis_lm_img_cal_distortion')
...
basic_reduction_sci_lm_img_task = (task('metis_lm_img_basic_reduce_sci')
...
basic_reduction_sky_lm_img_task = (task('metis_lm_img_basic_reduce_sky')
                    .with_recipe('metis_lm_img_basic_reduce')
...
basic_reduction_std_lm_img_task = (task('metis_lm_img_basic_reduce_std')
                    .with_recipe('metis_lm_img_basic_reduce')
...
background_sci_lm_img_task = (task('metis_lm_img_background_sci')
                    .with_recipe('metis_lm_img_background')
                    .with_main_input(basic_reduction_sci_lm_img_task)
                    .with_associated_input(basic_reduction_sky_lm_img_task)
                    .with_meta_targets([SCIENCE])
                    .build())

background_std_lm_img_task = (task('metis_lm_img_background_std')
                    .with_recipe('metis_lm_img_background')
                    .with_main_input(basic_reduction_sci_lm_img_task)
                    .with_associated_input(basic_reduction_sky_lm_img_task)
                    .with_meta_targets([SCIENCE])
...
standard_flux_lm_img_task = (task('metis_lm_img_standard_flux')
                    .with_recipe('metis_lm_img_std_process')
                    .with_main_input(background_std_lm_img_task)
                    .with_associated_input(fluxstd_catalog)
                    .with_meta_targets([SCIENCE])
                    .build())

calib_lm_img_task = (task('metis_lm_img_calib')
             .with_recipe('metis_lm_img_calibrate')
             .with_main_input(background_sci_lm_img_task)
             .with_associated_input(standard_flux_lm_img_task)
             .with_associated_input(distortion_lm_img_task)
             .with_meta_targets([SCIENCE])
             .build())
             
coadd_lm_img_task = (task('metis_lm_img_coadd')
             .with_recipe('metis_lm_img_sci_postprocess')
             .with_main_input(calib_lm_img_task)
             .with_meta_targets([SCIENCE])
             .build())
# QC1
