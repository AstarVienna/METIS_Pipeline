...
ifu_std_reduce_task = (task("metis_ifu_std_reduce")
            ...
            .with_input_filter(linearity_ifu_class, gain_map_ifu_class, master_dark_ifu_class, persistence_map_class, ifu_distortion_table_class, ifu_wavecal_class, rsrf_ifu_class)
            .build())
