...
class MetisIfuDistortion(Recipe):
    ...
    _description = (
        ...
        "frames present in the same input are ignored for tracing purposes for the time being."
        " This is a deliberate deviation, agreed in review (PR #220) as the DRLD input list being "
