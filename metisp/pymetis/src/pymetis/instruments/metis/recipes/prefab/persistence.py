...
class PersistenceCorrectionMixin:
    ...
    def correct_persistence(self, raw_images: ImageList) -> ImageList:
        ...
        """
        persistence = self.inputset.persistence_map.load_data(extension=r'PERSISTENCE_MAP')
        raw_images.subtract_image(persistence)

        Msg.info(self.__class__.__qualname__, "Pretending to do persistence correction")
        return raw_images
