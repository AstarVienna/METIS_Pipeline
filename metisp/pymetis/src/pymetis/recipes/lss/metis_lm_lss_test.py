...
# THIS IS A TESTRECIPE ONLY - IT's MAIN PURPOSE IS TO BE IGNORED!!!
...
class MetisLmLssTestImpl(RawImageProcessor):  # TODO replace parent class?
...
class MetisLmLssTest(MetisRecipe):
    """Determine chopper home position
    """
    # Recipe information
    _name: str = "metis_lm_lss_test"
    _version: str = "0.1"
    ...
    implementation_class = MetisLmLssTestImpl
