...
class MetisTestRecipeImpl(RawImageProcessor):  # TODO replace parent class?
...
class MetisTestRecipe(MetisRecipe):
    """Determine chopper home position
    """
    # Recipe information
    _name: str = "metis_testrecipe"
    _version: str = "0.1"
    ...
    implementation_class = MetisTestRecipeImpl
