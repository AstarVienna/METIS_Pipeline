...
class MetisCreateFileImpl(RawImageProcessor):
    ...
    # # Background image TODO: Check need for WCU OFF!!!
    ...
    class ProductMasterLmLssRsrf(PipelineProduct):
        ...
        _description: str = "ADC slitlosses"
        ...
        def add_properties(self):
            super().add_properties()
            self.properties.append(self.header)
    # class Product(MetisRecipeImpl.Product):
        # band: str = "LM"
...
class MetisCreateFile(MetisRecipe):
    ...
    _synopsis: str = "Create a file"
    _undescription: str = """\
    Stupid routine to create missing files
...
# TODO: Check whether WCU_OFF frames are necessary as input (cf. ifu rsrf recipe)
    ...
    _algorithm = """Fancy description follows """ # TODO: Write description

    """
    Define parameters
    """
    # Combining method (median or mean foreseen, more TBD)
