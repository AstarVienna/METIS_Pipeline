...
rsrf_task = (task('metis_LM_lss_rsrf')
...
trace_task = (task("metis_LM_lss_trace")
...
wave_task = (task("metis_LM_lss_wave")
...
std_reduction = (task('metis_LM_lss_std')
...
sci_reduction = (task('metis_LM_lss_sci')
