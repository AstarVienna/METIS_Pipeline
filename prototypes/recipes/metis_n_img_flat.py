...
class MetisNImgFlat(ui.PyRecipe):
    ...
    def run(self, frameset: ui.FrameSet, settings: Dict[str, Any]) -> ui.FrameSet:
        ...
        method = self.parameters["metis_n_img_flat.stacking.method"].value
        ...
        product_properties.append(
            ...
            # TODO: Twilight
                core.Property("ESO PRO CATG", core.Type.STRING, r"MASTER_IMG_FLAT_LAMP_N")
        )
