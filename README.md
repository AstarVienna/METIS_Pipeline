...
To run using UV, a docker file, or MTR with GUI, follow the instructions [here](toolbox/README.md)

To install and run manually, follow the instructions [here](metisp/README.md))

For basic instructions on running recipes and workflows go [here](metisp/README.md#running-the-software)
